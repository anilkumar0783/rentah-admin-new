...
function AddUser() {
  ...
  //     .then(async response => {
  //       const countriesData =await response.data.map(country => ({
  //         label: `${country.name.common} (${country.idd.root}${country.idd.suffixes})`,
  ...
  const handlePhoneChange = (e) => {
    ...
    // Regular expression to check if the value is a valid integer
    ...
    if (isValid) {
      ...
      setError('Enter phone no. without -, + , .');
    }
  };
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className='col-md-10'>
            ...
            <a className="navbar-brand text-dark fs-2 mt-2" href="#">Add Business User</a>
            ...
            <div className='row'>
              ...
              <div className='col-md-6 mt-5'>
                <form method='post' onSubmit={(e) => { handleSubmit(e) }}>
                  ...
                  <Autocomplete
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        style={{ width: 610, marginTop: "20px" }}
                      />
                    )}
                  ...
                  <label className='form-lable mt-3'>Profile Picture</label>
                  <input type='file' className='form-control ' placeholder='Profile Picture'
                    onChange={handleImg}
                  />
                  <img src={profilePicture} style={{ width: "100px" }} className='mt-3' />
                  <br />
                  <label className='form-lable mt-3'>Cover Image</label>
                  <input type='file' className='form-control ' placeholder='Profile Picture'
                    onChange={handleImg2}
                  />
                  <img src={coverImage} style={{ width: "100px" }} className='mt-3' />
                  <br />
                  <input type='text' className='form-control mt-3' placeholder='Cash App Id'
                    value={cashAppId}
                    onChange={(e) => { setCashAppId(e.target.value) }}
                  />

                  <input type='text' className='form-control mt-3' placeholder='Website'
                    value={website}
                    onChange={(e) => { setWebsite(e.target.value) }}
                  />

                  <select className='form-select mt-3' placeholder='Device Type' onChange={(e) => { setDeviceType(e.target.value) }}>
