                ...
                <div className="row">
                    ...
                    <div className='col-md-10'>
                        {loaded == false ?
                            ...
                            <div className="loader" style={{ marginLeft: "40%", marginTop: "21%" }}>
                                <Bars
                            ...
                            <>
                                <ToastContainer />
                                <div className="accordion mt-5" id="accordionExample" style={{ display: "block" }}>
                                                ...
                                                <div className="send-noti-div-p">
                                                    <div className="send-noti-div">
                                                        <form method="post" onSubmit={(e) => { handleSubmit(e) }}>
                                                            ...
                                                            <br />
                                                            <textarea className="text-area form-control" value={message} onChange={(e) => { setMessage(e.target.value) }} id="msg1"></textarea>
                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                            <div className="accordion-body">
                                                <div className="send-noti-div-p">
                                                    <div className="send-noti-div">
                                                        <form method="post" onSubmit={(e) => { handleSubmitPaticular(e) }}>
                                                            <label className="form-label mt-3 ">Title</label>
                                                            <br />
                                                            <input type="text" className=" form-control"
                                                                value={title}
                                                            ...
                                                            <label className="form-label ">Message</label>
                                                            <br />
                                                            <textarea className="text-area form-control" value={message} onChange={(e) => { setMessage(e.target.value) }} id="msg2"></textarea>
                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                            <div className="accordion-body">
                                                <div className="send-noti-div-p">
                                                    <div className="send-noti-div">
                                                        <form method="post" onSubmit={(e) => { handleSubmitByCategory(e) }}>
                                                            <label className="form-label mt-3 ">Title</label>
                                                            <br />
                                                            <input type="text" className=" form-control"
                                                                value={title}
                                                            ...
                                                            <label className="form-label ">Message</label>
                                                            <br />
                                                            <textarea className="text-area form-control" value={message} onChange={(e) => { setMessage(e.target.value) }} id="msg3"></textarea>
                                                            <select className="form-select mt-3" onChange={(e) => { handleCategory(e) }} id="cate">
                                                            ...
                                                            {subCategoryData?.map(i => (
                                                                <div class="form-check form-check-inline mt-3">
                                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" checked={subCategories.includes(i)} value={i} onChange={handleCheckBox} />
